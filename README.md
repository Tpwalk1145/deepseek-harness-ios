...
- Current packages (content identical, two jailbreak targets): rootless (Dopamine) `dsh-ios_0.1.5-rc.2-1_iphoneos-arm64.deb` + `nodejs_22.23.2-4_iphoneos-arm64.deb`; roothide (RootHide Bootstrap) `dsh-ios_0.1.5-rc.2-1_iphoneos-arm64e.deb` + `nodejs_22.23.2-4_iphoneos-arm64e.deb` (not yet device-verified). All in [dist/](dist/).
